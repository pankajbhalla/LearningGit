...
Run com.pcftraining.rest.webservices.restfulwebservices.RestfulWebServicesApplication as a Java Application.
...
- http://localhost:8080/hello-world/path-variable/pcftraining

```json
{"message":"Hello World, pcftraining"}
```
...
```
Pushing from manifest to org currency-services / space development as ranga@pcftraining.com...
Using manifest file /pcftraining/git/pcf-crash-course-with-spring-boot/01-hello-world-rest-api/manifest.yml
Getting app info...
Updating app with these attributes...
  name:                hello-world-rest-api
  path:                /pcftraining/git/pcf-crash-course-with-spring-boot/01-hello-world-rest-api/target/hello-world-rest-api.jar
  disk quota:          1G
